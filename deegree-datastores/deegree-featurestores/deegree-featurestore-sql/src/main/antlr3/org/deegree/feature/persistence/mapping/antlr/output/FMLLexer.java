    ...
    public final void mIdentifier() throws RecognitionException {
        try {
            ...
            do {
                ...
                if ( ((LA1_0>='0' && LA1_0<='9')||(LA1_0>='A' && LA1_0<='Z')||LA1_0=='_'||(LA1_0>='a' && LA1_0<='z')||(LA1_0>='\u00C5' && LA1_0<='\u00F8')) ) {
                    alt1=1;
                }
            	...
            	case 1 :
            	    ...
            	    {
            	    if ( (input.LA(1)>='0' && input.LA(1)<='9')||(input.LA(1)>='A' && input.LA(1)<='Z')||input.LA(1)=='_'||(input.LA(1)>='a' && input.LA(1)<='z')||(input.LA(1) >= '\u00C5' && input.LA(1) <= '\u00F8') ) {
            	        input.consume();
